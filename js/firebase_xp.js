...
import { getFirestore, initializeFirestore, addDoc, and, setDoc, collection, collectionGroup, deleteDoc, disableNetwork, doc, enableNetwork, getCountFromServer, getDoc, getDocs, increment, limit, memoryLocalCache, onSnapshot, orderBy, persistentLocalCache, persistentMultipleTabManager, query, runTransaction, serverTimestamp, startAfter, updateDoc, where } from "https://www.gstatic.com/firebasejs/10.12.3/firebase-firestore.js";
...
export { deleteApp, addDoc, and, collection, deleteDoc, doc, getCountFromServer, setDoc, getDoc, getDocs, limit, orderBy, query, serverTimestamp, startAfter, where };
